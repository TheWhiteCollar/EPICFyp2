...
public class addNewPaymentCheque extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (!cheque.equals("")){
            Boolean inserted = PaymentDAO.addPayment(1, "Cheque", cheque, amountI);
            TripStudentDAO.addTripStudent(user.getUserEmail(), 1, "test", "datetime");
            if (inserted==true) {
                response.sendRedirect("paymentMade.jsp?paymentId=" + "1");
                return;
            } else {
